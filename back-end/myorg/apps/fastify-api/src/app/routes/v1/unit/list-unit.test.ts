...
describe('GET /api/v1/unit', () => {
  ...
  it('should return a list of units', async () => {
    ...
    expect(body.items.length).toBe(units.length);
  });

  it('should filter units by name', async () => {
    const response = await server.inject({
      method: 'GET',
      url: '/api/v1/unit?filter[name]=Test',
      headers: {
        Authorization: `Bearer ${jwtToken}`,
      },
    });
  ...
  it('should order units by name descending', async () => {
    const response = await server.inject({
      method: 'GET',
      url: '/api/v1/unit?orderBy[name]=desc',
      headers: {
        Authorization: `Bearer ${jwtToken}`,
      },
    });
  ...
  it('should paginate results', async () => {
    ...
    const response = await server.inject({
      method: 'GET',
      url: `/api/v1/unit?page=1&pageSize=${pageSize}`,
      headers: {
        Authorization: `Bearer ${jwtToken}`,
      },
    });
  ...
  it('should return 400 for invalid query parameters', async () => {
    const response = await server.inject({
      method: 'GET',
      url: '/api/v1/unit?invalidQueryParam=1000',
      headers: {
        Authorization: `Bearer ${jwtToken}`,
      },
    });
