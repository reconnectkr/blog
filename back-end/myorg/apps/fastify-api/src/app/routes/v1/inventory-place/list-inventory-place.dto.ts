...
export const ListInventoryPlaceOrderBySchema = z.object({
...
export const ListInventoryPlaceQueryStringSchema = z
  .object({
    filter: z
      .object({
    ...
    orderBy: z
      .union([
        ListInventoryPlaceOrderBySchema,
        ListInventoryPlaceOrderBySchema.array(),
      ])
      .default({ id: 'asc' }),
  })
  .strict();
export type ListInventoryPlaceQueryString = z.infer<
  typeof ListInventoryPlaceQueryStringSchema
>;

export const ListInventoryPlaceResponseSchema = z
  .object({
    items: z
      .object({
        id: z.number(),
  ...
  .strict();
export type ListInventoryPlaceResponse = z.infer<
  typeof ListInventoryPlaceResponseSchema
>;
