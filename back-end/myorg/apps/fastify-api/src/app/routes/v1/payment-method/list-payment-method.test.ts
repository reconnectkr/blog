...
describe('GET /api/v1/payment-method', () => {
  ...
  it('should return a list of paymentMethods', async () => {
    ...
    expect(body.items.length).toBe(paymentMethods.length);
  });

  it('should filter paymentMethods by name', async () => {
    const response = await server.inject({
      method: 'GET',
      url: '/api/v1/payment-method?filter[name][contains]=MENT',
      headers: {
        Authorization: `Bearer ${jwtToken}`,
      },
    });
  ...
  it('should order paymentMethods by name descending', async () => {
    const response = await server.inject({
      method: 'GET',
      url: '/api/v1/payment-method?orderBy[name]=desc',
      headers: {
        Authorization: `Bearer ${jwtToken}`,
      },
    });
  ...
  it('should paginate results', async () => {
    ...
    const response = await server.inject({
      method: 'GET',
      url: `/api/v1/payment-method?page=1&pageSize=${pageSize}`,
      headers: {
        Authorization: `Bearer ${jwtToken}`,
      },
    });
  ...
  it('should return 400 for invalid query parameters', async () => {
    const response = await server.inject({
      method: 'GET',
      url: '/api/v1/payment-method?invalidQueryParam=1000',
      headers: {
        Authorization: `Bearer ${jwtToken}`,
      },
    });
